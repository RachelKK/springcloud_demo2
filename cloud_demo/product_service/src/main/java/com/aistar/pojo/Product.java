...
public class Product implements Serializable {
    ...
    public Product(String proId, String proName, Long proNum, Float proPrice) {
        this.proId = proId;
    ...
    public Product(String proId, String proName, Long proNum, Float proPrice, String proAddress,
                   String proColor, Float proSize, Date proDate) {
        this.proId = proId;
        this.proName = proName;
        this.proNum = proNum;
